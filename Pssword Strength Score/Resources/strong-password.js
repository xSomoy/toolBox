    ...
    if (pwd) {
        ...
        for (var c = 0; c < arrCharsLen; c++) {
            ...
            if (arrChars[c] == parseInt(minVal + 1)) {
                nReqChar++;
                oImg.className = "success";
                oBonus.parentNode.className = "success";
            } else if (arrChars[c] > parseInt(minVal + 1)) {
                nReqChar++;
                oImg.className = "exceed";
                oBonus.parentNode.className = "exceed";
            } else {
                oImg.className = "danger";
                oBonus.parentNode.className = "danger";
            }
        }
        ...
        for (var c = 0; c < arrCharsLen; c++) {
            ...
            if (arrChars[c] > 0) {
                ...
                oBonus.parentNode.className = "warning";
            } else {
                oImg.className = "success";
                oBonus.parentNode.className = "success";
            }
        ...
        oProgress.style.width = nScore + "%";
        oProgress.className = "progress-bar " + level;
    } else {
...
function initPwdChk(restart) {
    ...
    for (var i in arrPassPars) {
        $(arrPassPars[i]).parentNode.className = "success";
    }
    for (var i in arrPassDivs) {
        $(arrPassDivs[i]).className = "success";
    }
    for (var i in arrFailPars) {
        $(arrFailPars[i]).parentNode.className = "danger";
    }
    for (var i in arrFailDivs) {
        $(arrFailDivs[i]).className = "danger";
    }
    $("passwordPwd").value = "";
    $("passwordTxt").value = "";
    if (restart) {
        $("passwordPwd").className = "form-control";
